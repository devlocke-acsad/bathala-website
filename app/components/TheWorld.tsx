  ...
  return (
    <section id="the-world" className="py-20 px-4 bg-black text-white">
      <div className="w-3/5 mx-auto text-center">
        ...
        <p className="text-center mb-12 max-w-3xl mx-auto font-satoshi">
          In the beginning, the divine union of Bathala and Amihan created the
          islands—a paradise where elemental spirits, the *anito*, lived in
          perfect balance. But this harmony was shattered. The *engkanto*,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            <Image
              ...
              alt="The Corrupted Ancestral Forests"
              width={500}
              height={300}
